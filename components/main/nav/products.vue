...
<template>
  <div class="w-full flex justify-center bg-white dark:bg-gray-900 p-8">
    <div class="flex justify-evenly gap-8 w-[1180px]">
      <div class="flex flex-col w-[50%] justify-center gap-4">
